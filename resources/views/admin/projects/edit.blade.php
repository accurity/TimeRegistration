<x-admin-layout>
    <div class="mb-[22px] flex items-end justify-between">
        <h1 class="font-display text-[28px] font-bold leading-9 text-ink-900 dark:text-dark-text1">Project bewerken</h1>
        <a href="{{ route('admin.projects.time-entries.index', $project) }}" class="text-sm font-semibold text-brand-600 hover:text-brand-800 dark:text-brand-darkhover">Uren registreren</a>
    </div>
